...
Some examples for SPT: the AKLT phase; Intrinsic top order: (fractional) quantum hall phase, spin liquid phase, topological insulators. Thank you stackexchange! \cite{251464, 71160, 65897}. Here are some claims \cite{enwiki:1314883973}:
\begin{enumerate}
